...
(encoding artifacts cleaned up; wording unchanged). This was one of two options offered;
the other (Patient Appointment & Scheduling Portal) was declined and remains in git
history at commit `cbcb9a1`.
